...
class ResourceMixin(models.AbstractModel):
    ...
    def _get_work_days_data(
            self, from_datetime, to_datetime,
        ...
        # calculate total possible hours per day (with margin for first/last day)
        ...
        # calculate actual worked hours per day
        if compute_leaves:
        ...
        # compute days as fractions (quarters)
        days = sum(
